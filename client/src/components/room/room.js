...
const Room = (props) => {
    ...
    // let dummy_msgs2 = [{id: 12345, name: "yoni", text: "Alon Gever Gever Alon Gever Gever Alon Gever Gever Hello Ron, how are you doing today", time: 1589652174585},
    //     {id: 123456, name: "david", text: "Hi, i'm good! thank you for asking ", time: 1589652174540},
    //     {id: 12345, name: "yoni", text: "When is the estimated delivery on the project",time : 1589652174100},
    ...
    //     {id: 123456, name: "david", text: "Hi, i'm good! thank you for asking ", time: 1589652174540},
    //     {id: 12345, name: "yoni", text: "When is the estimated delivery on the project",time : 1589652174100},
    //     {id: 123456, name: "david", text: "Alon Gever Gever Alon Gever Gever It should be late noon 3", time: 1589652174000}];
    // let dummy_msgs4 = [{id: 12345, name: "yoni", text: "Hello Ron, how are you doing today", time: 1589652174585},
    //     {id: 123456, name: "david", text: "Hi, i'm good! thank you for asking ", time: 1589652174540},
    //     {id: 12345, name: "yoni", text: "Alon Gever Gever When is the estimated delivery on the project",time : 1589652174100},
    ...
    const [rooms,setRooms] = useState(dummy_rooms); // all rooms per user -> /room/:userId
    ...
    return (
          <div className={"mt-4 p-2 room"}>
              <div className={"message-header p-3 d-flex justify-content-left align-items-center"}>
                  <h5 className={"font-weight-bold m-0"} style={{color:"#3fb3a0"}}>Yoni</h5>
              </div>
